...
formulario.addEventListener('submit', (event) => {
    ...
    setTimeout(() => {
        ...
        let aseo = "Aseo " + (aseocheckbox.checked ? "✅" : "❌");
        let tarjetacheckbox = document.querySelector('#tarjeta');
        let tarjeta = "Tarjeta de Combustible " + (tarjetacheckbox.checked ? "✅" : "❌");
        let doccheckbox = document.querySelector('#doc');
        let doc = "Documentos Vehiculo " + (doccheckbox.checked ? "✅" : "❌");
        let bitacoracheckbox = document.querySelector('#bitacora');
        let bitacora = "Bitacora " + (bitacoracheckbox.checked ? "✅" : "❌");
        let llavecheckbox = document.querySelector('#llave');
        let llave = "Llave Rueda " + (llavecheckbox.checked ? "✅" : "❌");
        let gatacheckbox = document.querySelector('#gata');
        let gata = "Gata " + (gatacheckbox.checked ? "✅" : "❌");
        let ruedacheckbox = document.querySelector('#rueda');
        let rueda = "Rueda Repuesto " + (ruedacheckbox.checked ? "✅" : "❌");
        let extintorcheckbox = document.querySelector('#extintor');
        let extintor = "Extintor " + (extintorcheckbox.checked ? "✅" : "❌");
        ...
        + '*Conos:*' + " _" + conos + "_" +"%0a"
        + '*Cargos :*' +"%0a"+ " _" + aseo + ", " + tarjeta + ", " + "%0a"+ doc + ", " + bitacora + ", " + "%0a"+ llave + ", " + gata + ", " + "%0a"+ rueda + ", " + extintor + ", " + "%0a"+ botiquin + ", " + chaleco + "_" + "%0a"
        + '*Lugar:*' + " _" + lugar + "_" + "%0a"

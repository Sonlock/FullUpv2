...
formulario.addEventListener('submit', (event) => {
    ...
    setTimeout(() => {
        ...
        let aseo = document.querySelector('#aseo').value
        let tarjeta = document.querySelector('#tarjeta').value
        let doc = document.querySelector('#doc').value
        let bitacora = document.querySelector('#bitacora').value
        let llave = document.querySelector('#llave').value
        let gata = document.querySelector('#gata').value
        let rueda = document.querySelector('#rueda').value
        let extintor = document.querySelector('#extintor').value
        let botiquin = document.querySelector('#botiquin').value
        let chaleco = document.querySelector('#chaleco').value
        ...
        + '*Conos:*' + " _" + conos + "_" +"%0a"
        + '*Cargos Faltantes :*' + " _" + todos + aseo + tarjeta + doc + bitacora + llave + gata + rueda + extintor + botiquin + chaleco + "_" + "%0a"
        + '*Lugar:*' + " _" + lugar + "_" + "%0a"
        + '*Hora:*' + " _" + hora + ':' + minuto + "_" + ' *hrs.*'+ "%0a"
        + '*Boucher:*' + " _" + boucher + "_" + "%0a"
        + '*Estanque:*' + " _" + estanque + "_" + "%0a"
        + '*Novedades Vehiculo:*' + " _" + novedadesvehiculo + "_" + ''
